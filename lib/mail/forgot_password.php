          ...
          <tr>
            <td align='center'>
              <table class='table-inner' width='440' border='0' align='center' cellpadding='0' cellspacing='0'>
                ...
                <!--title-->
                <tr>
                  <td align='center' style='font-family: Open sans, Arial, sans-serif; color:#3b3b3b; font-size:22px;font-weight: bold; line-height: 28px;'>".$set['site_name']." Password Recovery</td>
                </tr>
                <!--end title-->
                <tr>
                  <td height='15'></td>
                ...
                <!--content-->
                <tr>
                  <td align='center' style='font-family: Open sans, Arial, sans-serif; color:#7f8c8d; font-size:14px; line-height: 28px;'>Request for password recovery. If this request wasn't made by you, please ignore this message.</td>
                </tr>
                <tr>
                  <td align='center' style='font-family: Open sans, Arial, sans-serif; color:#a7aeb3; font-size:13px; line-height: 28px;font-style: italic;'>*Click on the link below to reset your password ;</td>
                </tr>
                <!--button-->
                <tr>
                  <td align='center'>
                    <table class='textbutton' bgcolor='#ffb345' style='border-radius:4px;' border='0' align='center' cellpadding='0' cellspacing='0'>
                      <tr>
                        <td height='45' align='center' style='font-family: Open sans, Arial, sans-serif; color:#FFFFFF; font-size:16px;padding-left: 35px;padding-right: 35px; font-weight: bold;'><a href='".$url."/r_pass/".$token."'>Recover</a></td>
                      </tr>
                    </table>
                  </td>
                </tr>
