...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    file_put_contents('call.txt', print_r($request, true));
...
$message = '<h3>Dear '.$aname.'</h3>
Your account has been credited<h2>Transaction Summary</h2><h2 style="color:#06AF3E">N'.$amtshow.'</h2>Method: BANK TRANSFER<br/><br/>Thank you for choosing <strong>us</strong><br/><br/>If you have questions/complaints as regards this transaction, please reply this email';
