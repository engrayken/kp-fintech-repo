...
<?php if(addslashes($_GET['n2o7t18'])) { ?>
...
<?php if(addslashes($_GET['n2o7t18l'])) { ?>
 <div class="alert bg-orange alert-styled-left alert-arrow-left alert-dismissible">
          <button type="button" class="close" data-dismiss="alert"><span>&times;</span></button>
          <h6 class="alert-heading font-weight-semibold mb-1 text-uppercase">alert</h6>
         Sorry You have Exhaust or request more than your daily limit. please contact admin on 08126216200 to increase it.
          or visit www.carddispenser.com.ng for unlimited limit.
          </div>

<?php }?>

<?php if(addslashes($_GET['n2o7t18q'])) { ?>
 <div class="alert bg-orange alert-styled-left alert-arrow-left alert-dismissible">
          <button type="button" class="close" data-dismiss="alert"><span>&times;</span></button>
          <h6 class="alert-heading font-weight-semibold mb-1 text-uppercase">alert</h6>
...
<?php if(addslashes($_GET['lowwallet'])) { 
?>
 <div class="alert bg-orange alert-styled-left alert-arrow-left alert-dismissible">
          <button type="button" class="close" data-dismiss="alert"><span>&times;</span></button>
...
<?php if(addslashes($_GET['success'])) { ?>
...
<?php }?>
     ...
     <div class="card border-top-3 border-top-danger rounded-left-0">
      ...
      <h4>Order For Pins</h4>
          ...
          <form id="pur" action="airtime-pin" method="post">
  ...
  <label class="col-form-label col-lg-2">Phone Number</label>
      <div class="col-lg-10">
                  ...
                  <input type="text" name="phone" id="phone" maxlength="11" class="form-control" placeholder="08126216200" required /></div></div></div>
              <div class="form-group row">
     ...
     <input type="hidden" name="page" id="page" value="airtime-pin"> 
 ...
 <input type="hidden" name="token" id="token" value="<?php echo clean($token);?>"> 
         ...
         <option value="100">100 <?php echo ($scan2['currency']);?></option>
